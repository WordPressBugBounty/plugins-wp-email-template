...
class Uploader extends Admin_UI
{
	...
	public function upload_input ( $name_attribute, $id_attribute = '', $value = '', $attachment_id = 0, $default_value = '', $field_name = '', $class = '', $css = '', $description = '', $strip_methods = true, $size = 'original' ) {
		...
		$output .= '<input type="hidden" name="'.$attachment_id_name_attribute.'" id="'.$id_attribute.'_attachment_id" value="'.esc_attr( $attachment_id ).'" class=" a3_upload_attachment_id" />';
		$output .= '<input type="hidden" name="'.$attachment_size_name_attribute.'" id="'.$id_attribute.'_attachment_size" value="'.esc_attr( $size ).'" class=" a3_upload_attachment_size" />';
